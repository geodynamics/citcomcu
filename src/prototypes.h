...
void pg_solver(struct All_variables *E, float *T, float *Tdot, float *DTdot, float **V, struct SOURCES Q0, double diff, int bc, float **TBC, unsigned int *FLAGS);
void pg_shape_fn(struct All_variables *E, int el, struct Shape_function *PG, float **V, double rtf[4][9], double diffusion);
void element_residual(struct All_variables *E, int el, struct Shape_function PG, float **vel, float *field, float *fielddot, struct SOURCES Q0, double Eres[9], double rtf[4][9], double diff, float **BC, unsigned int *FLAGS);
...
void horizontal_bc(struct All_variables *E, float *BC[], int ROW, int dirn, double value, unsigned int mask, int onoff, int level);
...
float area_of_4node1(double x1, double y1, double x2, double y2, double x3, double y3, double x4, double y4);
float area_of_3node(double x1, double y1, double x2, double y2, double x3, double y3);
float mean_of_3node(int a, double x1, double y1, double x2, double y2, double x3, double y3);
float mean_of_4node(int a, double x1, double y1, double x2, double y2, double x3, double y3, double x4, double y4);
float mean_of_5node(int a, double x1, double y1, double x2, double y2, double x3, double y3, double x4, double y4, double x5, double y5);
...
float return_bulk_value(struct All_variables *E, float *Z, double z_thld, int average);
...
int layers(struct All_variables *E, double x3);
int weak_zones(struct All_variables *E, int node, double t_b);
