...
/*
 * This file contains the definitions of variables which are passed
 * as arguments to functions across the whole filespace of CITCOM.
...
/* 
 * To regenerate function prototypes, run the following command:
 * 
 *      cproto -D__CPROTO__ -q -p -f 3 *.c > prototypes.h
 *
 */
#ifndef __CPROTO__
