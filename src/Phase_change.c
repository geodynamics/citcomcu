  ...
  float *B6,*B_b6,*B4,*B_b4;
{
  ...
  if (been_here==0)  {
       ...
       E->control.Ra_670 = E->control.Ra_670*E->control.Atemp
               /(E->data.density*E->data.therm_exp*E->data.ref_temperature);
       E->control.Ra_410 = E->control.Ra_410*E->control.Atemp
               /(E->data.density*E->data.therm_exp*E->data.ref_temperature);

      E->control.clapeyron670 = E->control.clapeyron670*E->data.ref_temperature/
                       (E->data.density*E->data.grav_acc*E->monitor.length_scale);
  ...
  if (E->monitor.solution_cycles%E->control.record_every == 0)   {
      fprintf(E->fp,"fas=%g %g %g %g %g %g %g %g %g %g\n", E->control.clapeyron410,E->control.clapeyron670 ,E->control.Ra_410,E->control.Ra_670,E->control.transT410,E->control.transT670,E->control.width410,E->control.width670,E->viscosity.zlm,E->viscosity.z410);fflush(E->fp);
  }
