...
*/
 ...
 if (con==1)   {
  for (i=1;i<=E->advection.markers;i++)  {
    ...
    E->Vpred[1][i] = 
	     (weigh1*V[1][E->ien[el].node[1]] + weigh2*V[1][E->ien[el].node[2]] 
             +weigh3*V[1][E->ien[el].node[3]] + weigh4*V[1][E->ien[el].node[4]] 
             +weigh5*V[1][E->ien[el].node[5]] + weigh6*V[1][E->ien[el].node[6]] 
             +weigh7*V[1][E->ien[el].node[7]] + weigh8*V[1][E->ien[el].node[8]])
               /area;
    E->Vpred[2][i] =
	     (weigh1*V[2][E->ien[el].node[1]] + weigh2*V[2][E->ien[el].node[2]] 
             +weigh3*V[2][E->ien[el].node[3]] + weigh4*V[2][E->ien[el].node[4]] 
             +weigh5*V[2][E->ien[el].node[5]] + weigh6*V[2][E->ien[el].node[6]] 
             +weigh7*V[2][E->ien[el].node[7]] + weigh8*V[2][E->ien[el].node[8]])
               /area;
    E->Vpred[3][i] =
	     (weigh1*V[3][E->ien[el].node[1]] + weigh2*V[3][E->ien[el].node[2]] 
             +weigh3*V[3][E->ien[el].node[3]] + weigh4*V[3][E->ien[el].node[4]] 
             +weigh5*V[3][E->ien[el].node[5]] + weigh6*V[3][E->ien[el].node[6]] 
             +weigh7*V[3][E->ien[el].node[7]] + weigh8*V[3][E->ien[el].node[8]])
               /area;
